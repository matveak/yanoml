...
public:
	...
	void ensureJava(const QString &mcVersion, const QString &gameDir, const std::function<void(QString)>& cb, const QString& javaPath);

	void launchGame(const QJsonObject &root, const QString &gameDir, const QString &version, const QString &versionDir, const QString &mainClass, const QString &javaPath, QString username, int ram, int neededJava);

	void launchModded(const QJsonObject &parentRoot, const QJsonObject &childRoot, const QString &gameDir, const QString &mcVersion, const QString &versionId, const QString &javaPath, QString username, int ram, int neededJava);
