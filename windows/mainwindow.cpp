                                    ...
                                    const QString& gameDir)
{
    ...
    autoumenconn = std::make_shared<QMetaObject::Connection>();
    *conexion = connect(downloader, &MinecraftDownloader::loaderInstalled, this,
                    [this, conexion](const QString& versionId)
                    {
                        disconnect(*conexion);
